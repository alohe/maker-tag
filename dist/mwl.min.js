class MakerTag {
  constructor({
    text: t = "Made with ❤️ by Alohe",
    link: e = "https://alohe.github.io",
    position: a = "bottom-left",
    background:
      i = "radial-gradient(circle at left, #FFE2A3 0%, #fff 50%, #FFE2A3 100%)",
    color: o = "#E59F0D",
    padding: s = "10px 20px",
    margin: r = "10px",
    font: n = { size: "13px", weight: "700" },
    borderRadius: h = "13px",
    hover: d = { color: "", background: "", shadow: "" },
    shadow: g = "none",
    animated: m = !0,
  }) {
    (this.tagText = t),
  ...
  createWidget() {
    ...
    i.className = `maker__tag maker__tag__position--${this.tagPosition}`;
    let o = document.createElement("a");
    (o.href = this.tagLink),
      (o.className = "made__by__link"),
      (o.target = "_blank");
    let s = document.createElement("p");
    (s.className = "made__by__text"),
      (s.textContent = this.tagText),
      o.appendChild(s),
      i.appendChild(o),
  ...
  render() {
    ...
    t.className = `maker__tag maker__tag__position--${this.options.tagPosition}`;
    let e = document.createElement("a");
    (e.href = this.options.tagLink),
      (e.className = "made__by__link"),
      (e.target = "_blank");
    let a = document.createElement("p");
    (a.className = "made__by__text"),
      (a.textContent = this.options.tagText),
      e.appendChild(a),
      t.appendChild(e),
